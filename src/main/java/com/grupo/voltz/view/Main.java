...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
            ...
            switch (op) {
                case 1:
                    ...
                    if (conta == null) {
                        ...
                        // Mantém a funcionalidade: se o nomeInvestidor for nulo, seta "Investidor"
                ...
                case 2:
                    ...
                    // Cria um objeto Conta; o construtor pode ser o que utiliza o nome, email e senha
        ...
        } while (op != 0 && conta == null);

        // Se o login foi realizado, prossiga com o sistema
        if (conta != null) {
            System.out.println("\nBem-vindo, " + conta.getNomeInvestidor() + "!");
            // Aqui você pode chamar o menu principal ou outras funcionalidades da aplicação

            System.out.println("            SISTEMA DE INVESTIMENTO         ");
            System.out.println("                  BEM VINDO                 ");

            System.out.println("\nOlá, " + conta.getNomeInvestidor() + "!\n");
